...
const Footer = () => {
  ...
  return (
    <>
          <Box sx={{ mt: "70px",bgcolor:"black", p: "15px 30px",color:"black",borderTop:"1px solid "}}>
                    <Grid container sx={{ p: "5px 10px 20px 10px" }}>
                        <Grid item lg={4} md={4} sm={6} xs={12} sx={{ display: "flex", justifyContent: { lg: "center", md: "center", sm: "left", xs: "left" } }}>
                            <Box sx={{ mt: "20px" }}>
                            <Box sx={{height:"60px",width:"120px",position:"relative"}}>
                                 <Image src={logo} alt='logo'  style={{position:"absolute",height:"100%",width:"100%"}}/>
                            </Box>
                                <Typography sx={{color:"white",mt:"20px" }}>
                        ...
                        <Grid item lg={3} md={3} sm={6} xs={12} sx={{ display: "flex", justifyContent: { lg: "center", md: "center", sm: "left", xs: "left" } }}>
                            <Box sx={{ mt: "20px" }}>
                                ...
                                <Typography sx={{ color: "#757575", display: "flex", alignItems: "center", mt: "10px", cursor: "pointer",color:"white" }} >
